...
<head>
    ...
    <style>
      ...
      .search-container {
        ...
        padding: 20px;
        position: relative;
        margin-top: 60px; /* Add space for the back button */
    ...
    width: 300px;
    margin: 0 auto;
    background-color: #2d343c; /* Slightly lighter than the background */
    border-radius: 8px; /* Optional: to round the corners of the container */
    box-shadow: 0 4px 8px rgba(0, 0, 0, 0.2); /* Optional: to give a shadow effect */
    padding: 10px;
    display: none;  /* Hide it by default */
    top: 80px;  /* Adjust this to control the distance from the search bar */
    left: 50%;
    transform: translateX(-50%);
      ...
      .suggestions li:hover {
        color: #c9d1d9;
        background-color: #3d4c56; /* Light background on hover */
      }
...
<body>
    ...
    <div id="product-list" class="product-container">
        ...
        if (isset($products) && !empty($products)) {
            foreach ($products as $product) {
                ...
                echo '<a href="product.php?id=' . $product['id'] . '" class="add-to-cart">View Product</a>';
                echo '</div>';
            }
        } else {
            echo '<p>.</p>';
    ...
    <script>
        // Search input event listener for dynamic suggestions
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (suggestions.length > 0) {
                            ...
                            // Hide the suggestions container if no suggestions
                            suggestionsContainer.hide();
                        }
                    }
                });
            } else {
                // Hide suggestions if no input is present
                $('.suggestions-container').hide();
            }
        });

        // When a suggestion is clicked, redirect to the search results page with the query
        $(document).on('click', '#suggestions-list li', function() {
            var productName = $(this).text();
            window.location.href = 'search_results.php?query=' + encodeURIComponent(productName);
        });
